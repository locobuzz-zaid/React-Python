...
export const HighVelocityViewAll = () => {
      ...
      <div style={{ margin: "30px" }}>
        ...
        <Row className="content-section">
          <Col className="content-column-tab twitter-tab">
            {typeof dashboardsData?.[dashboardActiveKey]
              ?.high_velocity_news_list?.data === "string" ? (
              <>
              ...
              <>
                {dashboardsData?.[
                  dashboardActiveKey
                ]?.high_velocity_news_list?.data?.map((data, index) => {
                  return (
                    <HighVelocityNews
                      key={index}
                      {...data}
